...
urlpatterns = [
    ...
    url(r'^app/kmlmap/create/$', views.KmlmapCreateViewPart.as_view(), name="kmlmap_edit"),
    url(r'^app/kmlmap/(?P<datamap_id>\d+)/metadata/$', views.SocrataDatamapMetadata.as_view(), name="kmlmap_metadata"),
   	...
   	url(r'^kmlmap/list/json/$', views.DataMapListJson.as_view(), name="kmlmap_list_json"),
